...
class Application:
    ...
    def __init__(self):
        ...
        self.T4.place(x=250, y=655)
        self.T4.config(text="Suggestions :", fg="red", font=("Courier", 15, "bold"))

        self.bt1 = tk.Button(self.root, command=self.action1, height=0, width=0)
        self.bt1.place(x=26, y=695)

        self.bt2 = tk.Button(self.root, command=self.action2, height=0, width=0)
        self.bt2.place(x=325, y=695)

        self.bt3 = tk.Button(self.root, command=self.action3, height=0, width=0)
        self.bt3.place(x=625, y=695)

        self.panel5 = tk.Label(self.root)  # Audio
        self.panel5.place(x=220, y=715)

        self.T3 = tk.Label(self.root)
        self.T3.place(x=10, y=715)
        self.T3.config(text="Audio :", font=("Courier", 15, "bold"))
